...
from .players.human_user import HumanUser
from .visualizations.console_visualization import ConsoleVisualization
from .visualizations.web_visualization import WebVisualization
from .visualizations.visualization import VisualizationManager
...
class RealGame:
    ...
    def setup_interfaces(self) -> bool:
        ...
        try:
            ...
            self.viz_log_file = os.path.join(logs_dir, "game_viz.log")
